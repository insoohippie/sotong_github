...
//               child: SafeArea(
//                 top: false,
//                 child: Consumer<RecordAddIncomeViewModel>(
//                   builder: (context, incomeVm, _) {
//                     final entries = incomeVm.incomeEntries;
...
//                               children: [
//                                 ...entries.map((entry) {
//                                   final amountCtrl = entry['amountController']
//                                   as TextEditingController;
//                                   final noteCtrl = entry['noteController']
//                                   as TextEditingController;
//
...
//                                               onSelected: (val) {
//                                                 entry['category'] = val;
//                                                 entry['categoryKey'] = val;
//                                                 incomeVm.notifyListeners();
//                                               },
//                                             );
//                                           },
...
//                                             onPressed: () {
//                                               if (entries.length <= 1) {
//                                                 _snack('최소 1줄은 남겨야 해요.');
//                                                 return;
//                                               }
//                                               incomeVm.removeEntryByRef(entry);
//                                             },
//                                             child: const Text(
//                                               '이 줄 삭제',
...
//                                   child: Text(
//                                     '총 수입: ${incomeVm.totalFormattedWithWon}',
...
//                             text: '완료',
//                             height: 56,
//                             enabled: incomeVm.canProceedToNextStep,
//                             onPressed: () async {
//                               try {
//                                 final date = _argDate ?? DateTime.now();
//                                 await incomeVm.saveAllForDate(date);
//
...
//                   ? note
//                   : (category.isNotEmpty ? category : '수입');
//
//               return Column(
//                 children: [
//                   _incomeTile(
//                     entry: e,
//                     title: title,
//                     amountText: amount > 0 ? _formatAmount(amount) : '',
...
//                         child: const Center(
//                           child:
//                           Icon(Icons.edit, color: Color(0xFF999999), size: 11),
//                         ),
//                       ),
//                     ),
//                   ],
...
//           ),
//           child: Text(
//             category.isEmpty ? '카테고리 미선택' : category,
//             style: const TextStyle(
//               color: Color(0xFF666666),
//               fontSize: 13,
//               fontWeight: FontWeight.w500,
