...
class AddIncomeInputEntry extends StatefulWidget {
  ...
  @override
  State<AddIncomeInputEntry> createState() => _AddIncomeInputEntryState();
}

class _AddIncomeInputEntryState extends State<AddIncomeInputEntry> {
  ...
  @override
  void didUpdateWidget(covariant AddIncomeInputEntry oldWidget) {
