...
class MiniPlan {
  ...
  MiniPlan copyWith({
    ...
    String? prevDocId,
    String? nextDocId,
    bool clearPrevDocId = false,
    bool clearNextDocId = false,
    ...
    return MiniPlan(
      ...
      prevDocId: clearPrevDocId ? null : (prevDocId ?? this.prevDocId),
      nextDocId: clearNextDocId ? null : (nextDocId ?? this.nextDocId),
