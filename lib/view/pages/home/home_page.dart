...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final todayIncome = vm.selectedDateIncome; // 하경 추가
    final todaySpending = vm.selectedDateSpending; // 하경 추가
    ...
    final todaySpendingText = vm.selectedDateSpendingText; // 하경 추가
    final isUnrecorded = !vm.isSelectedDateRecorded; // 하경 추가
