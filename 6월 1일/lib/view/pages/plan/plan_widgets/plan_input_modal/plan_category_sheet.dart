    ...
    builder: (ctx) {
      return StatefulBuilder(
        builder: (modalContext, setModalState) {
          ...
          final panelBg = isDark ? theme.colorScheme.surface : const Color(0xFFF9FAFB);
          final chipBg = isDark ? theme.colorScheme.surfaceContainerHighest : const Color(0xFFF3F4F6);
          final chipBorder = isDark ? theme.dividerColor : const Color(0xFFE5E7EB);
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: showAddUI
                                    ? (isDark ? theme.colorScheme.surface : const Color(0xFFD1D5DB))
                                    : chipBg,
                                borderRadius: BorderRadius.circular(14),
                                border: Border.all(
                                  color: showAddUI
                                      ? (isDark ? theme.dividerColor : const Color(0xFF9CA3AF))
                                      : chipBorder,
                                ),
                              ),
                              child: Icon(
